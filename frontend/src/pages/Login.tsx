                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="text-center mt-4">
                                <span className="text-muted-foreground text-sm">New to Krishi-Mate? </span>
                                <Link to="/signup" className="text-primary font-medium hover:underline text-sm">Create Account</Link>
                            </div>
                        </form>
